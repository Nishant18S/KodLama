...
<body>
    ...
    <a href="javascript:location.reload()" style="text-decoration: none;">
        <span class="title" style="font-weight: bold; font-size: 21px" >R.A.I.S.E</span>
</a>
<!--<img src=".gif" alt="" class="background-image" />-->
        <div class="navbar">
            ...
            <div class="user-info">
                ...
                <div class="user-icon">
                    <img id="user-icon" src="img\user_icon.png" alt="User Icon" />
                </div>
...
<footer>
    <div class="footer-container">
        <p>&copy; 2025 FraudStar. All rights reserved.Developing Rural Education Initiative Platform</p>
        <p></p>
    </div>
</footer>
